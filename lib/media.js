...
/**
 * Deterministic portrait placeholder for a given seed. We use face portraits
 * (pravatar) so generated results resemble the reference design's people.
 */
function pictureFor(seed) {
